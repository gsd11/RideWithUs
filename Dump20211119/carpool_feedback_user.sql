...
CREATE TABLE `feedback_user` (
  ...
  `feedcomment` varchar(255) DEFAULT NULL,
  `feedemail` varchar(255) DEFAULT NULL,
  `feedname` varchar(255) DEFAULT NULL,
  `feedsubject` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`feedid`)
...
INSERT INTO `feedback_user` VALUES (27,'adsda','gauravd@11','abc','ajsdhas'),(32,'werf4etr54 5t45t r5ty 54y ','srger@hjdh.ff','ertgwdtt','regqartwe5t');
