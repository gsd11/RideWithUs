			...
			$.each(responseJson , function(key,value){
				if(purpose == "booking"){
					if(processBy == "from"){
						...
						'<input type="radio" class="mr-1" name="from_city" value="'+value[0]+'"/>'+value[1]+'</label></li>'
					);
					}
					...
					if(processBy == "to"){
						...
						'<input type="radio" class="mr-1" name="to_city" value="'+value[0]+'"/>'+value[1]+' </label></li>'
					);
					}
						...
						'<input type="radio" class="mr-1" name="from_city_leaving" value="'+value[0]+'"/>'+value[1]+'</label></li>'
					);
					}
					...
					if(processBy == "to"){
						...
						'<input type="radio" class="mr-1" name="to_city_going" value="'+value[0]+'"/>'+value[1]+'</label></li>'
					);
					}
				}
			});
